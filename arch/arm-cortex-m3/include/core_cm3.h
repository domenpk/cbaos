...
typedef struct
{
  __O  union  
  {
	  /* renamed, because I really like u8/u16/u32 as type names */
    __O  uint8_t    _u8;                       /*!< Offset:       ITM Stimulus Port 8-bit                   */
    __O  uint16_t   _u16;                      /*!< Offset:       ITM Stimulus Port 16-bit                  */
    __O  uint32_t   _u32;                      /*!< Offset:       ITM Stimulus Port 32-bit                  */
...
static __INLINE uint32_t ITM_SendChar (uint32_t ch)
{
  ...
  {
    while (ITM->PORT[0]._u32 == 0);
    ITM->PORT[0]._u8 = (uint8_t) ch;
  }  
  return (ch);
}
